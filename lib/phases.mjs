...
export const PHASES = [
  {
    ...
    tasks: [
      ...
      { name: 'Architecture overview', description: 'High-level file tree, component structure, tech choices, and infrastructure requirements (database, hosting, env vars)', rewardRange: [0.50, 1.00] },
